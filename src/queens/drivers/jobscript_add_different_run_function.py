...
class Jobscript(Driver):
    ...
    def run(self, sample, job_id, num_procs, experiment_dir, experiment_name):
        ...
        return self.run_from_dict(sample_dict, job_id, num_procs, experiment_dir, experiment_name)

    def run_from_dict(self, sample_dict, job_id, num_procs, experiment_dir, experiment_name):
        """Run the driver."""
