...
class TestCluster:
    ...
    def fixture_experiment_dir(self, test_name, remote_connection, test_base_directory_on_cluster):
        """Fixture providing the remote experiment directory."""
        experiment_dir, _ = remote_connection.run_function(
            experiment_directory, test_name, test_base_directory_on_cluster
        )
